...
| 文档 | 路径 | 内容 | 页数 |
|------|------|------|------|
| **审计报告** | `docs/archive/_audit/PROJECT_AUDIT_REPORT.md` | 全面审计结果、问题识别、整合方案 | ~300 行 |
| **执行计划** | `docs/archive/_audit/EXECUTION_PLAN.md` | 分步骤执行计划、Git commit 策略 | ~300 行 |
| **删除清单** | `docs/archive/_audit/DELETE_LIST.md` | 待删除文件清单、删除理由、恢复方法 | ~300 行 |
| **保留清单** | `docs/archive/_audit/KEEP_LIST.md` | 保留文件清单、用途说明、运行方式 | ~300 行 |
...
### 审计相关
- `docs/archive/_audit/PROJECT_AUDIT_REPORT.md` - 审计报告
- `docs/archive/_audit/EXECUTION_PLAN.md` - 执行计划
- `docs/archive/_audit/DELETE_LIST.md` - 删除清单
- `docs/archive/_audit/KEEP_LIST.md` - 保留清单
