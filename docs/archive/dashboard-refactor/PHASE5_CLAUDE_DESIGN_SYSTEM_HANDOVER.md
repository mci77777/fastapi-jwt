...
- **设计原型**: `docs/archive/dashboard-refactor/UI_DESIGN_V6_CLAUDE.html`
- **设计迭代总结**: `docs/archive/dashboard-refactor/CLAUDE_STYLE_ITERATION_SUMMARY.md`
- **架构概览**: `docs/archive/dashboard-refactor/ARCHITECTURE_OVERVIEW.md`
- **实施规格**: `docs/archive/dashboard-refactor/IMPLEMENTATION_SPEC.md`
