...
1. **方案 A**: `docs/archive/dashboard-refactor/UI_DESIGN_V1.html`
2. **方案 B**: `docs/archive/dashboard-refactor/UI_DESIGN_V2.html`
3. **混合方案（推荐）**: `docs/archive/dashboard-refactor/UI_DESIGN_PREVIEW.html` ⭐
