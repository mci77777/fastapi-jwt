...
# 4. 创建数据库表
# 在Supabase SQL Editor中执行: docs/archive/jwt改造/COMPLETE_REBUILD_FOR_ANDROID.sql
...
# 4. 部署监控配置
# 参考监控配置: docs/archive/jwt改造/K4_OBSERVABILITY_SLO.md

# 5. 灰度发布
# 按照 docs/archive/jwt改造/K5_DELIVERY_REPORT.md 中的流程执行
```
...
**📋 验收标准**:
- [x] docs/archive/jwt改造/ 目录下含K1/K3/K4/K5全部阶段文档与索引页
- [x] 仓库中无残缺链接到 docs/archive/jwt改/
- [x] K5_DELIVERY_REPORT.md含扫描结果、Newman概览、双构建数据、发布tag与回滚演练记录
- [x] 所有文档路径已修正为 docs/archive/jwt改造/*
