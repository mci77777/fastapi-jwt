...
### 数据库文件
```
docs/archive/jwt改造/GYMBRO_COMPLETE_SUPABASE_SCHEMA.sql    # 完整数据库结构 (1,192行)
docs/archive/jwt改造/ANON/ANON_RLS_POLICIES.sql            # 匿名用户RLS策略
docs/archive/jwt改造/ANON_RLS_ROLLBACK.sql                 # 完整回滚脚本
```

### 文档文件
```
docs/archive/jwt改造/SUPABASE_DASHBOARD_SETUP.md           # 详细设置指南
docs/archive/jwt改造/SUPABASE_QUICK_SETUP_CHECKLIST.md     # 快速设置清单
docs/archive/jwt改造/ANON_BACKEND_POLICY.md                # 后端策略文档
docs/archive/jwt改造/ANON_ENDPOINT_MATRIX.md               # 端点访问矩阵
docs/archive/jwt改造/ANON_RLS_README.md                    # RLS策略说明
docs/archive/jwt改造/T2_BACKEND_DELIVERY_REPORT.md         # T2交付报告
docs/archive/jwt改造/T3_RLS_DELIVERY_REPORT.md             # T3交付报告
docs/archive/jwt改造/T3_SUPABASE_SCHEMA_DELIVERY_REPORT.md # 数据库迁移报告
docs/archive/jwt改造/ANON_IMPLEMENTATION_FINAL_REPORT.md   # 最终实现报告
```
...
# 文件: docs/archive/jwt改造/GYMBRO_COMPLETE_SUPABASE_SCHEMA.sql
```
