...
1. **打开测试工具**：
   ```
   file:///d:/GymBro/vue-fastapi-admin/scripts/testing/frontend/browser_test_ws.html
   ```
...
# 验证 JWT token
python scripts/testing/jwt/test_complete.py --token <token>

# 验证 JWKS 缓存
python -X utf8 scripts/verification/verify_jwks_cache.py
```
...
- WebSocket 测试工具: file:///d:/GymBro/vue-fastapi-admin/scripts/testing/frontend/browser_test_ws.html
