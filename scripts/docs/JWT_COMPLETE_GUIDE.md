...
**工具地址**：`file:///d:/GymBro/vue-fastapi-admin/scripts/testing/frontend/inject_token_to_browser.html`
...
```bash
# 使用 JWT 分析工具
python -X utf8 scripts/utils/analyze_jwt.py "<your-token>"
```

3. **验证 Token**：
```bash
# 使用 JWT 完整测试脚本
python -X utf8 scripts/testing/jwt/test_complete.py --token "<your-token>"
```
...
- **登录指南**：`scripts/docs/LOGIN_GUIDE.md`
- **诊断报告**：`scripts/docs/DIAGNOSIS_REPORT.md`
- **JWT 分析工具**：`scripts/utils/analyze_jwt.py`
- **JWT 完整测试**：`scripts/testing/jwt/test_complete.py`
- **Token 注入工具**：`scripts/testing/frontend/inject_token_to_browser.html`
- **WebSocket 测试工具**：`scripts/testing/frontend/browser_test_ws.html`
